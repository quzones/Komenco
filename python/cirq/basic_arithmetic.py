...
import cirq
from cirq.contrib.qasm_import import circuit_from_qasm # we use this to flatten circuits 
import sys
sys.path.append('../')
...
def experiment_adder(p, q, n=3):
    ...
    #flatten the circuit, equivalent to decompose in qiskit
    circuit = circuit_from_qasm(circuit.to_qasm())
    
    # Run the Circuit using Automatski' Quantum Simulators and Quantum Computers
    simulator = AutomatskiKomencoCirq(host="103.212.120.18", port=80)

    # Run the circuit and get results
    samples = simulator.run(circuit, repetitions=1, topK=20)
